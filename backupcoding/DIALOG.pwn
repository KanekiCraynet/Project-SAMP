...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	if(dialogid == DIALOG_RENT_BIKE)
	{
		...
		switch(listitem)
		{
			case 0:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0,1682.7796,-2264.0961,13.5116))
				{
					Rented_Bike[playerid] = CreateVehicle(481,1682.3327,-2257.3098,13.3503,271.7581,3,4,120000,0);
				}
			...
			case 1:
			{
				if(IsPlayerInRangeOfPoint(playerid,2.0,1682.7796,-2264.0961,13.5116))
				{
					Rented_Bike[playerid] = CreateVehicle(510,1682.3327,-2257.3098,13.3503,271.7581,3,4,120000,0);
				}
				if(IsPlayerInRangeOfPoint(playerid,2.0,1811.7331,-1876.9458,13.5781))
				{
